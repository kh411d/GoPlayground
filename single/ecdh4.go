...
func main() {
	...
	err := gr.Check(peerPub)
	fmt.Println(err)
	x := gr.ComputeSecret(priv, peerPub)
...
func (g *Group) GenerateKey(random io.Reader) (private *big.Int, public *big.Int, err error) {
	if g.P == nil {
...
func (g *Group) PublicKey(private *big.Int) (public *big.Int) {
	public = new(big.Int).Exp(g.G, private, g.P)
	return
}
...
func (g *Group) Check(peersPublic *big.Int) (err error) {
...
func (g *Group) ComputeSecret(private *big.Int, peersPublic *big.Int) (secret *big.Int) {
